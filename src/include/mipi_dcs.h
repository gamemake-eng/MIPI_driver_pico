//Entirely copied from here: https://github.com/tuupola/hagl_pico_mipi/blob/master/include/mipi_dcs.h because I am lazy
//Thanks tuupola on github :)
...
//MIPI commands (I might delete some of these if not needed)
